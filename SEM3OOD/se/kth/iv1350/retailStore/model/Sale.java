...
public class Sale {
     ...
     * @throws ItemNotFoundException if item is not found in inventorysytem. Meaning no matching item ID in the inventory sytem.
     * @throws DataBaseFailureException if the database cant be called.  
     */
